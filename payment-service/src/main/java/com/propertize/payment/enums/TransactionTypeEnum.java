...
/**
 * Enum representing transaction types in the payment system.
 * Used to categorize all financial transactions for reporting and auditing.
 *
    ...
    public boolean isCredit() {
        return switch (this) {
            case APPLICATION_FEE, RENT_PAYMENT, RENT_PARTIAL, RENT_ADVANCE,
                 ...
                 NSF_FEE, UTILITY_PAYMENT, MAINTENANCE_CHARGE, SUBSCRIPTION_PAYMENT -> true;
            default -> false;
        };
    }
    ...
    public boolean isDebit() {
        return switch (this) {
            case APPLICATION_FEE_REFUND, SECURITY_DEPOSIT_REFUND, PET_DEPOSIT_REFUND,
                 ...
                 OWNER_PAYOUT, VENDOR_PAYMENT -> true;
            default -> false;
        };
    }
    ...
    public boolean isTenantRelated() {
        return switch (this) {
            case APPLICATION_FEE, APPLICATION_FEE_REFUND, RENT_PAYMENT, RENT_PARTIAL,
                 ...
                 MAINTENANCE_CHARGE, REFUND -> true;
            default -> false;
        };
    }
}
