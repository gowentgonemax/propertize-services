...
COMMENT ON COLUMN password_reset_tokens.expiry_date IS 'When the token expires (typically 24 hours from creation)';
COMMENT ON COLUMN password_reset_tokens.used IS 'Flag indicating if the token has been used';
